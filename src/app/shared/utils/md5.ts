...
export default class MD5 {
  ...
  public static encrypt(s: string): string {
   ...
   */
  private static hex_md5(s: string) {
    return this.rstr2hex(this.rstr_md5(this.str2rstr_utf8(s)));
  }

  private static b64_md5(s: any) {
    return this.rstr2b64(this.rstr_md5(this.str2rstr_utf8(s)));
  }

  private static any_md5(s: any, e: any) {
    return this.rstr2any(this.rstr_md5(this.str2rstr_utf8(s)), e);
  }

  private static hex_hmac_md5(k: any, d: any) {
    return this.rstr2hex(this.rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d)));
  }

  private static b64_hmac_md5(k: any, d: any) {
    return this.rstr2b64(this.rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d)));
  }

  private static any_hmac_md5(k: any, d: any, e: any) {
   ...
   */
  private static rstr_hmac_md5(key: string, data: string) {
   ...
   */
  private static rstr2b64(input: string) {
    try {
      this.b64pad;
    } catch (e) {
      this.b64pad = '';
   ...
   */
  private static rstr2any(input: string, encoding: { length: number; charAt: (arg0: any) => string }) {
    const divisor = encoding.length;
    let i: number, j: number, q: number, x: number, quotient: any[];
   ...
   */
  private static str2rstr_utf8(input: { length: number; charCodeAt: { (arg0: number): void; (arg0: number): void } }) {
    let output = '';
    let i = -1;
    let x: any;
    let y: any;
  ...
  private static str2rstr_utf16le(input: {
    length: number;
    charCodeAt: { (arg0: number): number; (arg0: number): number };
  }) {
    let output = '';
    for (let i = 0; i < input.length; i++)
   ...
   */
  private static rstr2binl(input: { length: number; charCodeAt: (arg0: number) => number }) {
   ...
   */
  private static binl_md5(x: any[], len: number) {
    /* append padding */
    x[len >> 5] |= 0x80 << len % 32;
    x[(((len + 64) >>> 9) << 4) + 14] = len;
   ...
   */
  private static md5_cmn(q: number, a: any, b: any, x: any, s: any, t: any) {
    return this.safe_add(this.bit_rol(this.safe_add(this.safe_add(a, q), this.safe_add(x, t)), s), b);
  }

  private static md5_ff(a: number, b: number, c: number, d: number, x: any, s: number, t: number) {
    return this.md5_cmn((b & c) | (~b & d), a, b, x, s, t);
  }

  private static md5_gg(a: number, b: number, c: number, d: number, x: any, s: number, t: number) {
    return this.md5_cmn((b & d) | (c & ~d), a, b, x, s, t);
  }

  private static md5_hh(a: number, b: number, c: number, d: number, x: any, s: number, t: number) {
    return this.md5_cmn(b ^ c ^ d, a, b, x, s, t);
  }

  private static md5_ii(a: number, b: number, c: number, d: number, x: any, s: number, t: number) {
